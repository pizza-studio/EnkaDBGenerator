...
extension DimModels4HSR {
    struct DimDB4HSR {
        ...
        init(withLang: Bool = true, oneByOne: Bool = false, localPath: String? = nil) async throws {
            let dataStack: [DimModels4HSR: Data] = try await getDataStack(
                oneByOne: oneByOne, isCollab: false, localPath: localPath
            )
            let dataStack4Collab: [DimModels4HSR: Data] = try await getDataStack(
                oneByOne: oneByOne, isCollab: true, localPath: localPath
            )
